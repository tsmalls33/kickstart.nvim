  ...
  },
  {
    ...
    config = function()
      ...
      local servers = {
        ...
        -- ts_ls = {},
        --
        -- TODO: Insert typescript language server config
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      formatters_by_ft = {
        ...
        -- enable eslint_d for diagnostics, not formatting (handled by LSP/Linters)
        ['*'] = {}, -- leave empty for other filetypes unless needed
      },
    },
  },
